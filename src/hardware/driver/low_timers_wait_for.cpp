...
/**
     ...
     */
std::chrono::high_resolution_clock::time_point low_timers_wait_for::wait_for_tick_us(const std::chrono::high_resolution_clock::time_point& prev_timer, const double t)
{
